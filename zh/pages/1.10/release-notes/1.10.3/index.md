...
- If you are currently running *DC/OS Enterprise 1.9.X* and plan to upgrade to DC/OS Enterprise 1.10, upgrade directly to DC/OS Enterprise 1.10.3 following the standard upgrade procedure. No additional remediations are required.

- If you are currently running *DC/OS Enterprise 1.10.0, 1.10.1, or 1.10.2*, first restart CockroachDB, on each master, in a rolling fashion, by running:
...
You can find additional information and a more robust remediation procedure in [our latest critical product advisory](https://support.mesosphere.com/hc/en-us/articles/115005698043).
