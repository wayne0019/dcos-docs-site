...
A single element of the [`env` field](https://mesosphere.github.io/marathon/docs/task-environment-vars.html) can be updated by specifying a JSON string in a command argument.
...
The entire [`env` field](/1.10/cli/) can also be updated by specifying a JSON file in a command argument.
