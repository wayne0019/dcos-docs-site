...
By default apps are launched on private nodes. For more information, see the [documentation](/1.10/administering-clusters/convert-agent-type/).

## What is meant by service ports in a Marathon app?

A service port is the globally-unique port assigned to the app when using automatic app discovery through a proxy or load balancer system, as described in [Service Discovery and Load Balancing](/1.10/networking/load-balancing-vips/).
...
A comprehensive overview of a few common service discovery implementations is available at [Service Discovery](/1.10/networking/) in Marathon.
...
Please review this link on [the Mesosphere Knowledge Base](https://support.mesosphere.com/hc/en-us/articles/206474745-How-to-reserve-resources-for-certain-frameworks-in-Mesos-cluster-).
...
For more information, see the installation [documentation](/1.10/installing/oss/). <!-- Intentionally linked to dcos.io, since this page does not exist in docs.mesosphere.com -->
