...
* **Container:** metrics about cgroup allocations from tasks running in the DC/OS [Universal Container Runtime](/1.10/deploying-services/containerizers/ucr/) or [Docker Engine](/1.10/deploying-services/containerizers/docker-containerizer/) runtime. 
