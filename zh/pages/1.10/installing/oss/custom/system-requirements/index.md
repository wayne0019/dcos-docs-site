...
- **CentOS** - [Install Docker from Docker's yum repository](/1.10/installing/oss/custom/system-requirements/install-docker-centos/).
...
To use the [GUI](/1.10/installing/oss/custom/gui/) or [CLI](/1.10/installing/oss/custom/cli/) installation methods, you must disable password prompts for sudo.
...
Download and save the [DC/OS setup file](https://downloads.dcos.io/dcos/stable/dcos_generate_config.sh) to your bootstrap node. This file is used to create your customized DC/OS build file.
...
- [GUI DC/OS Installation Guide](/1.10/installing/oss/custom/gui/)
- [CLI DC/OS Installation Guide](/1.10/installing/oss/custom/cli/)
- [Advanced DC/OS Installation Guide](/1.10/installing/oss/custom/advanced/)