...
- **CentOS** - [Install Docker from Docker's yum repository](/1.10/installing/ent/custom/system-requirements/install-docker-centos/).
...
To use the [GUI](/1.10/installing/ent/custom/gui/) or [CLI](/1.10/installing/ent/custom/cli/) installation methods, you must disable password prompts for sudo.
...
[Download and save](https://support.mesosphere.com/hc/en-us/articles/213198586-Mesosphere-Enterprise-DC-OS-Downloads) the DC/OS setup file to your bootstrap node. This file is used to create your customized DC/OS build file. Contact your sales representative or <sales@mesosphere.com> for access to this file.
...
- [GUI DC/OS Installation Guide](/1.10/installing/ent/custom/gui/)
- [CLI DC/OS Installation Guide](/1.10/installing/ent/custom/cli/)
- [Advanced DC/OS Installation Guide](/1.10/installing/ent/custom/advanced/)