...
For more information, see the [multi-zone](/1.10/installing/high-availability/multi-zone/) and [multi-region](/1.10/installing/high-availability/multi-region/) documentation.
