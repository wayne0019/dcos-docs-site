...
1. Install Splunk's [universal forwarder](http://www.splunk.com/en_us/download/universal-forwarder.html).
...
For details on how to filter your logs with Splunk, see [Filtering logs with Splunk](../filter-splunk/).